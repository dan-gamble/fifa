...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vue3 = __webpack_require__(4);
	...
	new _vue2.default(_vue4.default).$mount('body');
...
/***/ function(module, exports, __webpack_require__) {
	...
	_vue2.default.filter('toString', function (val) {
	  return String(val);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlobalSearch = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] fifa/assets/js/components/builder/Builder.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/dangamble/Workspace/fifa/fifa/assets/js/components/builder/Builder.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  watch: {
	    'builder.selectedFormation': function builderSelectedFormation(val) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] fifa/assets/js/components/builder/Player.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/dangamble/Workspace/fifa/fifa/assets/js/components/builder/Player.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  vuex: {
	    actions: {
	      updatePlayer: _actions.updatePlayer,
	      updatePlayerChemistry: _actions.updatePlayerChemistry
	    }
	  },
	  ...
	  computed: {
	    overallChemistry: function overallChemistry() {
	      return (0, _values2.default)(this.player.chemistry).reduce(function (prev, next) {
	        return prev + next;
	      }) || 0;
	    }
	  },
	  ...
	  watch: {
	    'player.player': function playerPlayer(player) {
	      if (player) {
	        this.updatePlayerChemistry({ index: this.index, player: player, type: 'position' });
	        this.updatePlayerChemistry({ index: this.index, player: player, type: 'links' });
	      }
	    },
	    query: function query(val) {
	      ...
	      if (val !== '') {
	        this.$http.get('/api/players/', { query: this.query }).then(function (res) {
	  ...
	  methods: {
	    getResults: function getResults() {
	      ...
	      this.$nextTick(function () {
	        _this2.$els.input.focus();
	      });
	    },
	    processUpdatePlayer: function processUpdatePlayer(player, index) {
	      ...
	      this.updatePlayer({ player: player, index: index });
	      this.query = '';
...
/***/ function(module, exports) {
	...
	exports.updateSelectedFormation = updateSelectedFormation;
	exports.updatePlayer = updatePlayer;
	exports.updatePlayerChemistry = updatePlayerChemistry;
	exports.updatePlayerLinks = updatePlayerLinks;
	exports.updatePlayerPositions = updatePlayerPositions;
	function updateSelectedFormation(_ref, event) {
	  var dispatch = _ref.dispatch;
	
	  dispatch('UPDATE_SELECTED_FORMATION', event.target.value);
	}
	
	function updatePlayer(_ref2, data) {
	  var dispatch = _ref2.dispatch;
	
	  dispatch('UPDATE_PLAYER', data);
	}
	
	function updatePlayerChemistry(_ref3, data) {
	  var dispatch = _ref3.dispatch;
	
	  dispatch('UPDATE_PLAYER_CHEMISTRY', data);
	}
	
	function updatePlayerLinks(_ref4, data) {
	  var dispatch = _ref4.dispatch;
	
	  dispatch('UPDATE_PLAYER_LINKS', data);
	}
	
	function updatePlayerPositions(_ref5, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] fifa/assets/js/components/global-search/GlobalSearch.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/dangamble/Workspace/fifa/fifa/assets/js/components/global-search/GlobalSearch.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _positionChem = __webpack_require__(86);
	
	var _positionChem2 = _interopRequireDefault(_positionChem);
	
	var _positionLinks = __webpack_require__(87);
	
	var _positionLinks2 = _interopRequireDefault(_positionLinks);
	
	var _positionMap = __webpack_require__(88);
	...
	var mutations = {
	  'UPDATE_SELECTED_FORMATION': function UPDATE_SELECTED_FORMATION(state, val) {
	    state.selectedFormation = val;
	  },
	  'UPDATE_PLAYER': function UPDATE_PLAYER(state, data) {
	    state.players[data.index].player = data.player;
	  },
	  'UPDATE_PLAYER_CHEMISTRY': function UPDATE_PLAYER_CHEMISTRY(state, data) {
	    if (data.type === 'position') {
	      var positionChemMap = state.players[data.index].position + ':' + data.player.position;
	
	      state.players[data.index].chemistry[data.type] = _positionChem2.default[positionChemMap];
	      ...
	      try {
	        for (var _iterator = (0, _getIterator3.default)(state.players[data.index].links), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var link = _step.value;
	
	          if (state.players[link].player.hasOwnProperty('league') && state.players[data.index].player.hasOwnProperty('league')) {
	            totalLinks += 1;
	          }
	
	          if (state.players[link].player.hasOwnProperty('league') && state.players[data.index].player.hasOwnProperty('league') && state.players[link].player.league.ea_id === state.players[data.index].player.league.ea_id) {
	            total += 1 / 3 * 3;
	          }
	        }
	      } catch (err) {
	  ...
	  'UPDATE_PLAYER_LINKS': function UPDATE_PLAYER_LINKS(state, data) {
	    var links = _positionLinks2.default[data.formation];
	  ...
	  'UPDATE_PLAYER_POSITIONS': function UPDATE_PLAYER_POSITIONS(state, data) {
	    var positions = _positionMap2.default[data.formation];
